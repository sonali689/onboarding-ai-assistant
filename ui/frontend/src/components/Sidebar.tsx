    ...
    <div style={{ background: '#003DA5' }} className="w-64 flex flex-col h-full shrink-0 select-none">
      ...
      <div className="px-5 pt-5 pb-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.12)' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-white text-xs mt-0.5" style={{ opacity: 0.5 }}>Onboarding Assistant</div>
          </div>
        </div>
      ...
      <div className="px-3 py-3">
        <button
          ...
          style={{ color: 'rgba(255,255,255,0.9)', border: '1px solid rgba(255,255,255,0.2)' }}
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-3 space-y-0.5">
        {sessions.length === 0 ? (
          <p className="text-center text-xs px-4 mt-4 leading-relaxed" style={{ color: 'rgba(255,255,255,0.25)' }}>
            {t.noChats}
          </p>
        ) : (
          sessions.map(s => (
            <div
              ...
              style={{
                background: activeId === s.id ? 'rgba(255,255,255,1)' : hoverId === s.id ? 'rgba(255,255,255,0.1)' : 'transparent',
              }}
            ...
            >
              <button
                ...
                style={{
                  color:      activeId === s.id ? '#003DA5' : 'rgba(255,255,255,0.7)',
              ...
              {hoverId === s.id && (
                <button
                  ...
                  onMouseEnter={e => { const el = e.currentTarget as HTMLButtonElement; el.style.color = '#ffffff'; el.style.background = 'rgba(255,255,255,0.15)' }}
                  onMouseLeave={e => { const el = e.currentTarget as HTMLButtonElement; el.style.color = 'rgba(255,255,255,0.4)'; el.style.background = 'transparent' }}
                >
                  <Trash2 size={11} />
                </button>
              )}
        ...
        <div className="px-3 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.12)' }}>
          <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl" style={{ background: 'rgba(255,255,255,0.08)' }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs truncate mt-0.5" style={{ color: 'rgba(255,255,255,0.4)', fontSize: '10px' }}>
                {user.email}
              </p>
            </div>
          ...
          <p className="text-xs mt-2 text-center" style={{ color: 'rgba(255,255,255,0.2)', fontSize: '10px' }}>
            {t.localAI}
          </p>
        </div>
      )}
